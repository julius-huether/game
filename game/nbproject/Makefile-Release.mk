...
${OBJECTDIR}/_ext/1472/api.o: ../api.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/api.o ../api.cpp

${OBJECTDIR}/_ext/1472/executor.o: ../executor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/executor.o ../executor.cpp

${OBJECTDIR}/_ext/1472/httphandler.o: ../httphandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/httphandler.o ../httphandler.cpp

${OBJECTDIR}/_ext/1472/strutil.o: ../strutil.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/strutil.o ../strutil.cpp
